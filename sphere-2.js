...
function init3D() {
    ...
    canvas_s = document.getElementById( "c" );
    ...
    scene_s.userData.camera = camera_s;
    ...
    scene_s.userData.controls = controller_s;
    ...
    scene_s.userData.element = element.querySelector( ".scene" );
